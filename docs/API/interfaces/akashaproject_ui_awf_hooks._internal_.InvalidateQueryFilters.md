[AWF](../README.md) / [Modules](../modules.md) / [@akashaproject/ui-awf-hooks](../modules/akashaproject_ui_awf_hooks.md) / [<internal\>](../modules/akashaproject_ui_awf_hooks._internal_.md) / InvalidateQueryFilters

# Interface: InvalidateQueryFilters<TPageData\>

[@akashaproject/ui-awf-hooks](../modules/akashaproject_ui_awf_hooks.md).[<internal>](../modules/akashaproject_ui_awf_hooks._internal_.md).InvalidateQueryFilters
...
- [active](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#active)
- [exact](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#exact)
- [fetching](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#fetching)
- [inactive](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#inactive)
- [queryKey](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#querykey)
- [refetchActive](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#refetchactive)
- [refetchInactive](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#refetchinactive)
- [stale](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#stale)

### Methods

- [predicate](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#predicate)
- [refetchPage](akashaproject_ui_awf_hooks._internal_.InvalidateQueryFilters.md#refetchpage)
...
• `Optional` **refetchActive**: `boolean`

#### Defined in

ui/hooks/node_modules/react-query/types/core/types.d.ts:190

___

### refetchInactive

• `Optional` **refetchInactive**: `boolean`

#### Defined in

ui/hooks/node_modules/react-query/types/core/types.d.ts:191
