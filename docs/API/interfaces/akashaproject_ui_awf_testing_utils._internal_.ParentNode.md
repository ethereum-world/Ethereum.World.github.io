[AWF](../README.md) / [Modules](../modules.md) / [@akashaproject/ui-awf-testing-utils](../modules/akashaproject_ui_awf_testing_utils.md) / [<internal\>](../modules/akashaproject_ui_awf_testing_utils._internal_.md) / ParentNode

# Interface: ParentNode

[@akashaproject/ui-awf-testing-utils](../modules/akashaproject_ui_awf_testing_utils.md).[<internal>](../modules/akashaproject_ui_awf_testing_utils._internal_.md).ParentNode
...
- [ATTRIBUTE\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#attribute_node)
- [CDATA\_SECTION\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#cdata_section_node)
- [COMMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_fragment_node)
- [DOCUMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#document_type_node)
- [ELEMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#element_node)
- [ENTITY\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#entity_reference_node)
- [NOTATION\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#processing_instruction_node)
- [TEXT\_NODE](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#text_node)
- [baseURI](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#baseuri)
- [childElementCount](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#childelementcount)
- [childNodes](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#childnodes)
- [children](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#children)
- [firstChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#firstchild)
- [firstElementChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#firstelementchild)
- [isConnected](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#isconnected)
- [lastChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#lastchild)
- [lastElementChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#lastelementchild)
- [nextSibling](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#nextsibling)
- [nodeName](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#nodename)
- [nodeType](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#nodetype)
- [nodeValue](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#nodevalue)
- [ownerDocument](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#ownerdocument)
- [parentElement](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#parentelement)
- [parentNode](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#parentnode)
- [previousSibling](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#previoussibling)
- [textContent](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#textcontent)

### Methods

- [addEventListener](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#addeventlistener)
- [append](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#append)
- [appendChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#appendchild)
- [cloneNode](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#clonenode)
- [compareDocumentPosition](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#comparedocumentposition)
- [contains](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#contains)
- [dispatchEvent](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#dispatchevent)
- [getRootNode](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#getrootnode)
- [hasChildNodes](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#haschildnodes)
- [insertBefore](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#insertbefore)
- [isDefaultNamespace](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#isdefaultnamespace)
- [isEqualNode](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#isequalnode)
- [isSameNode](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#issamenode)
- [lookupNamespaceURI](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#lookupnamespaceuri)
- [lookupPrefix](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#lookupprefix)
- [normalize](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#normalize)
- [prepend](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#prepend)
- [querySelector](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#queryselector)
- [querySelectorAll](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#queryselectorall)
- [removeChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#removechild)
- [removeEventListener](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#removeeventlistener)
- [replaceChild](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#replacechild)
- [replaceChildren](akashaproject_ui_awf_testing_utils._internal_.ParentNode.md#replacechildren)
