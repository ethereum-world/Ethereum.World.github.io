[AWF](../README.md) / [Modules](../modules.md) / [@akashaproject/design-system](../modules/akashaproject_design_system.md) / [<internal\>](../modules/akashaproject_design_system._internal_.md) / TemplateStringsArray

# Interface: TemplateStringsArray

[@akashaproject/design-system](../modules/akashaproject_design_system.md).[<internal>](../modules/akashaproject_design_system._internal_.md).TemplateStringsArray
...
- [length](akashaproject_design_system._internal_.TemplateStringsArray.md#length)
- [raw](akashaproject_design_system._internal_.TemplateStringsArray.md#raw)

### Methods

- [[iterator]](akashaproject_design_system._internal_.TemplateStringsArray.md#[iterator])
- [concat](akashaproject_design_system._internal_.TemplateStringsArray.md#concat)
- [entries](akashaproject_design_system._internal_.TemplateStringsArray.md#entries)
- [every](akashaproject_design_system._internal_.TemplateStringsArray.md#every)
- [filter](akashaproject_design_system._internal_.TemplateStringsArray.md#filter)
- [find](akashaproject_design_system._internal_.TemplateStringsArray.md#find)
- [findIndex](akashaproject_design_system._internal_.TemplateStringsArray.md#findindex)
- [flat](akashaproject_design_system._internal_.TemplateStringsArray.md#flat)
- [flatMap](akashaproject_design_system._internal_.TemplateStringsArray.md#flatmap)
- [forEach](akashaproject_design_system._internal_.TemplateStringsArray.md#foreach)
- [includes](akashaproject_design_system._internal_.TemplateStringsArray.md#includes)
- [indexOf](akashaproject_design_system._internal_.TemplateStringsArray.md#indexof)
- [join](akashaproject_design_system._internal_.TemplateStringsArray.md#join)
- [keys](akashaproject_design_system._internal_.TemplateStringsArray.md#keys)
- [lastIndexOf](akashaproject_design_system._internal_.TemplateStringsArray.md#lastindexof)
- [map](akashaproject_design_system._internal_.TemplateStringsArray.md#map)
- [reduce](akashaproject_design_system._internal_.TemplateStringsArray.md#reduce)
- [reduceRight](akashaproject_design_system._internal_.TemplateStringsArray.md#reduceright)
- [slice](akashaproject_design_system._internal_.TemplateStringsArray.md#slice)
- [some](akashaproject_design_system._internal_.TemplateStringsArray.md#some)
- [toLocaleString](akashaproject_design_system._internal_.TemplateStringsArray.md#tolocalestring)
- [toString](akashaproject_design_system._internal_.TemplateStringsArray.md#tostring)
- [values](akashaproject_design_system._internal_.TemplateStringsArray.md#values)
...
▸ **[iterator]**(): [`IterableIterator`](akashaproject_design_system._internal_.IterableIterator.md)<`string`\>

Iterator of values in the array.

#### Returns

[`IterableIterator`](akashaproject_design_system._internal_.IterableIterator.md)<`string`\>

#### Inherited from

ReadonlyArray.\_\_@iterator@33237
...
| :------ | :------ | :------ |
| `...items` | [`ConcatArray`](akashaproject_design_system._internal_.ConcatArray.md)<`string`\>[] | Additional items to add to the end of array1. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `...items` | (`string` \| [`ConcatArray`](akashaproject_design_system._internal_.ConcatArray.md)<`string`\>)[] | Additional items to add to the end of array1. |
...
▸ **entries**(): [`IterableIterator`](akashaproject_design_system._internal_.IterableIterator.md)<[`number`, `string`]\>

Returns an iterable of key, value pairs for every entry in the array

#### Returns

[`IterableIterator`](akashaproject_design_system._internal_.IterableIterator.md)<[`number`, `string`]\>
...
▸ **values**(): [`IterableIterator`](akashaproject_design_system._internal_.IterableIterator.md)<`string`\>
