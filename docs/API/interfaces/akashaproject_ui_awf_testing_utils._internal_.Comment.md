[AWF](../README.md) / [Modules](../modules.md) / [@akashaproject/ui-awf-testing-utils](../modules/akashaproject_ui_awf_testing_utils.md) / [<internal\>](../modules/akashaproject_ui_awf_testing_utils._internal_.md) / Comment

# Interface: Comment

[@akashaproject/ui-awf-testing-utils](../modules/akashaproject_ui_awf_testing_utils.md).[<internal>](../modules/akashaproject_ui_awf_testing_utils._internal_.md).Comment
...
- [ATTRIBUTE\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#attribute_node)
- [CDATA\_SECTION\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#cdata_section_node)
- [COMMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_fragment_node)
- [DOCUMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#document_type_node)
- [ELEMENT\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#element_node)
- [ENTITY\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#entity_reference_node)
- [NOTATION\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#processing_instruction_node)
- [TEXT\_NODE](akashaproject_ui_awf_testing_utils._internal_.Comment.md#text_node)
- [baseURI](akashaproject_ui_awf_testing_utils._internal_.Comment.md#baseuri)
- [childNodes](akashaproject_ui_awf_testing_utils._internal_.Comment.md#childnodes)
- [data](akashaproject_ui_awf_testing_utils._internal_.Comment.md#data)
- [firstChild](akashaproject_ui_awf_testing_utils._internal_.Comment.md#firstchild)
- [isConnected](akashaproject_ui_awf_testing_utils._internal_.Comment.md#isconnected)
- [lastChild](akashaproject_ui_awf_testing_utils._internal_.Comment.md#lastchild)
- [length](akashaproject_ui_awf_testing_utils._internal_.Comment.md#length)
- [nextElementSibling](akashaproject_ui_awf_testing_utils._internal_.Comment.md#nextelementsibling)
- [nextSibling](akashaproject_ui_awf_testing_utils._internal_.Comment.md#nextsibling)
- [nodeName](akashaproject_ui_awf_testing_utils._internal_.Comment.md#nodename)
- [nodeType](akashaproject_ui_awf_testing_utils._internal_.Comment.md#nodetype)
- [nodeValue](akashaproject_ui_awf_testing_utils._internal_.Comment.md#nodevalue)
- [ownerDocument](akashaproject_ui_awf_testing_utils._internal_.Comment.md#ownerdocument)
- [parentElement](akashaproject_ui_awf_testing_utils._internal_.Comment.md#parentelement)
- [parentNode](akashaproject_ui_awf_testing_utils._internal_.Comment.md#parentnode)
- [previousElementSibling](akashaproject_ui_awf_testing_utils._internal_.Comment.md#previouselementsibling)
- [previousSibling](akashaproject_ui_awf_testing_utils._internal_.Comment.md#previoussibling)
- [textContent](akashaproject_ui_awf_testing_utils._internal_.Comment.md#textcontent)

### Methods

- [addEventListener](akashaproject_ui_awf_testing_utils._internal_.Comment.md#addeventlistener)
- [after](akashaproject_ui_awf_testing_utils._internal_.Comment.md#after)
- [appendChild](akashaproject_ui_awf_testing_utils._internal_.Comment.md#appendchild)
- [appendData](akashaproject_ui_awf_testing_utils._internal_.Comment.md#appenddata)
- [before](akashaproject_ui_awf_testing_utils._internal_.Comment.md#before)
- [cloneNode](akashaproject_ui_awf_testing_utils._internal_.Comment.md#clonenode)
- [compareDocumentPosition](akashaproject_ui_awf_testing_utils._internal_.Comment.md#comparedocumentposition)
- [contains](akashaproject_ui_awf_testing_utils._internal_.Comment.md#contains)
- [deleteData](akashaproject_ui_awf_testing_utils._internal_.Comment.md#deletedata)
- [dispatchEvent](akashaproject_ui_awf_testing_utils._internal_.Comment.md#dispatchevent)
- [getRootNode](akashaproject_ui_awf_testing_utils._internal_.Comment.md#getrootnode)
- [hasChildNodes](akashaproject_ui_awf_testing_utils._internal_.Comment.md#haschildnodes)
- [insertBefore](akashaproject_ui_awf_testing_utils._internal_.Comment.md#insertbefore)
- [insertData](akashaproject_ui_awf_testing_utils._internal_.Comment.md#insertdata)
- [isDefaultNamespace](akashaproject_ui_awf_testing_utils._internal_.Comment.md#isdefaultnamespace)
- [isEqualNode](akashaproject_ui_awf_testing_utils._internal_.Comment.md#isequalnode)
- [isSameNode](akashaproject_ui_awf_testing_utils._internal_.Comment.md#issamenode)
- [lookupNamespaceURI](akashaproject_ui_awf_testing_utils._internal_.Comment.md#lookupnamespaceuri)
- [lookupPrefix](akashaproject_ui_awf_testing_utils._internal_.Comment.md#lookupprefix)
- [normalize](akashaproject_ui_awf_testing_utils._internal_.Comment.md#normalize)
- [remove](akashaproject_ui_awf_testing_utils._internal_.Comment.md#remove)
- [removeChild](akashaproject_ui_awf_testing_utils._internal_.Comment.md#removechild)
- [removeEventListener](akashaproject_ui_awf_testing_utils._internal_.Comment.md#removeeventlistener)
- [replaceChild](akashaproject_ui_awf_testing_utils._internal_.Comment.md#replacechild)
- [replaceData](akashaproject_ui_awf_testing_utils._internal_.Comment.md#replacedata)
- [replaceWith](akashaproject_ui_awf_testing_utils._internal_.Comment.md#replacewith)
- [substringData](akashaproject_ui_awf_testing_utils._internal_.Comment.md#substringdata)
